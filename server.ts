    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        responseSchema: {
          type: Type.OBJECT,
          properties: {
            titleEn: { type: Type.STRING, description: "Translation of the Title into English" },
            titleRu: { type: Type.STRING, description: "Translation of the Title into Russian" },
            titleHu: { type: Type.STRING, description: "Translation of the Title into Hungarian" },
            descriptionEn: { type: Type.STRING, description: "Translation of the Description into English" },
            descriptionRu: { type: Type.STRING, description: "Translation of the Description into Russian" },
            descriptionHu: { type: Type.STRING, description: "Translation of the Description into Hungarian" },
          },
          required: ["titleEn", "titleRu", "titleHu", "descriptionEn", "descriptionRu", "descriptionHu"],
        }
      }
    });
