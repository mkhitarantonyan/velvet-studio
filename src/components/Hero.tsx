...
import manicureNudeImg from "/assets/images/manicure_nude_chic_1782970221462.jpg";
import manicureFrenchImg from "/assets/images/manicure_french_modern_1782970235107.jpg";
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
          ...
          <div className="mt-16 sm:mt-24 lg:mt-0 lg:col-span-5 flex justify-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-3 shadow-lg flex items-center gap-3">
                <img
                  src={manicureFrenchImg}
                  alt="Available slots preview"
                  className="h-10 w-10 rounded-lg object-cover shrink-0 border border-brand-100 shadow-sm"
                  referrerPolicy="no-referrer"
                />
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse shrink-0" />
                    <span className="text-xs font-bold text-brand-900 uppercase tracking-wider truncate">
                      {t("todayOpenSlots")}
                    </span>
                  </div>
                  <p className="text-[10px] text-brand-700 mt-0.5 leading-tight line-clamp-2">
                    {t("todayOpenSlotsDesc")}
                  </p>
                </div>
              </div>
            </motion.div>
